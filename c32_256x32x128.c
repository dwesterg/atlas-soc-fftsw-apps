...
#define FFT_FUNC	ne10_fft_c2c_1d_int32_c

const char *g_test = "c32_256x32x128";
const char *g_description = "256x32x128 point FFT, C implementation, 32-bit precision";
