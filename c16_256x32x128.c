...
#define FFT_FUNC	ne10_fft_c2c_1d_int16_c

const char *g_test = "c16_256x32x128";
const char *g_description = "256x32x128 point FFT, C implementation, 16-bit precision";
